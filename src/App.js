    ...
    <div className="App">
      ...
      <div class="container grafica">
        <div class="row justify-content-md-center">
          ...
          {/* Gráficas */}
          <div id="graficos" class="col-md-8 grafico"><Graficas /><p class="parrafo">Fuente: Statista Digital Market Outlook</p></div>
          <div id="Mexico" class="col-md-8 grafico"><GrafMexico /><p class="parrafo">Fuente: Statista Digital Market Outlook</p></div>
